...
from model.Modified_Dense_UNet import getModel
...
B1 = 1.0
B2 = 0.01
train_filename = 'D:\Final_TARES_model\Datset_prep\data\\train\\train_set.npz'
valid_filename =  'D:\Final_TARES_model\Datset_prep\data\\test\\test_set.npz'
model_dir = 'model_dir_selu_only'
