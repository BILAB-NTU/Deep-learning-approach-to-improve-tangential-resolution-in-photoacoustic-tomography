...
def main():
    parser = GooeyParser()
    parser.add_argument('training_dataset', help='train directory',type=str, widget='FileChooser')
    parser.add_argument('validation_dataset', help='validation_directory', type=str, widget='FileChooser')
